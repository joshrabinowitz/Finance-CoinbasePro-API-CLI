...
Finance::CoinbasePro::API::CLI - The great new Finance::CoinbasePro::API::CLI!
...
Perhaps a little code snippet.
    ...
    my $foo = Finance::CoinbasePro::API::CLI->new();
    ...
...
L<http://annocpan.org/dist/Finance-CoinbasePro-API-CLI>
